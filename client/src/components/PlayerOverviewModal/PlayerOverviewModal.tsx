...
const PlayerOverviewModal = ({
  ...
  const baseRows: NumericRow[] = [
    ...
    { key: 'deck', label: 'Hand & Deck', value: player => player.deck.length, highlightBest: true },
  ...
  return (
    <BoardScopedModal isOpen overlayClassName="player-overview-overlay" onClose={onClose} closeOnOverlayClick>
